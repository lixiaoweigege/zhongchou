...
<!-- <base href="http://localhost:8080/atcrwodfunding-02-admin-webui/"/> -->
<base
		...
		<form action="admin/do/login.html" method="post" class="form-signin"
			...
			<div class="form-group has-success has-feedback">
				<input type="text" name="loginAcct" class="form-control"
					id="inputSuccess4"  placeholder="请输入登录账号" value="123" autofocus>
				<span class="glyphicon glyphicon-user form-control-feedback"></span>
			</div>
			<div class="form-group has-success has-feedback">
				<input type="text" name="userPswd" class="form-control"
					id="inputSuccess4" placeholder="请输入登录密码" value="123"
